...
$sendToEmail = 'kraus.patrik@gmail.com'; // Email address that will receive the message with the output of the form
$sendToName = 'Patrik Kraus'; // Name that will receive the message with the output of the form
